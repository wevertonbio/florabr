...
### Retrieving synonyms
We can retrieve all synonyms of a species list. This can be particularly useful, for example, when searching for records of a species and all its synonyms (as listed in the Brazilian Flora 2020) in online databases like GBIF. To accomplish this, utilize the function get_synonym. To understand how the function works, let's search for the synonyms of two species:
```{r}
...
```
We can see that *Araucaria angustifolia* has 12 synonyms in Brazilian Flora database, while *Adesmia paranensis* has one synonym.
