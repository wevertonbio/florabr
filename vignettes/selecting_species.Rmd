---
title: "Selecting and filtering species"
...
af_spp <- select_species(data = bf,
                      ...
                      Biome = "Atlantic_Forest", #Occuring in the Atlantic Forest
...
Furthermore, the package offers the flexibility to apply various filtering options (please consult `?select_species` for comprehensive details). For instance, consider the scenario where we aim to compile a list of native and endemic trees with confirmed occurrences limited solely to the Atlantic Forest biome and with confirmed occurrenced in the states of Paraná (PR), Santa Catarina (SC), and Rio Grande do Sul (RS):
...
## Checking names and subseting species
...
complete_names <- c("Araucaria brasiliana var. ridolfiana (Pi.Savi) Gordon",
                    ...
                    "Homo sapiens")
#Human specie was used just as an example that will be used to illustrate the next function
...
#> 4  Butia cattarinensis Probably_incorret   Butia catarinensis        1
...
To see how the function works, let's use the acceptes names in *checked_names* created previously:
...
#>                                                                           vegetationType
#> 11785                                                                           Restinga
#> 26790 High_Altitude_Grassland;Mixed_Ombrophyllous_Forest;Seasonally_Semideciduous_Forest
#> 99881                                                                           Restinga
...
#>                                                                  vernacularName
#> 11785                                                                      <NA>
#> 26790 araucaria, pinheiro-do-parana, curi, pinheiro-brasileiro, pinho-do-parana
#> 99881                                                                      <NA>
#>       taxonRank
#> 11785   Species
#> 26790   Species
