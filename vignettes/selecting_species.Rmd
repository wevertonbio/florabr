...
The filter returned 2362 species that meet the specified criteria. It's important to note that these selections include species with confirmed occurrences in the Atlantic Forest, and some of them may also have confirmed occurrences in other biomes.
...
Now, the filter has resulted in 1849 species, all exclusively confined to the Atlantic Forest biome.
