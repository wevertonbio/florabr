...
Additionally, you can choose between two versions of the data: the 'short' version (containing the 20 columns required for run the other functions of the package) or the 'complete' version (with all original 39 columns). The function imports the 'short' version by default.
